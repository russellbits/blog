...
type LayoutRouteId = RouteId | "/dashboard" | "/dashboard/create" | "/dashboard/edit/[slug]"
...
type ActionsExport = typeof import('../../../../../src/routes/dashboard/+page.server.js').actions
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/dashboard/+layout.server.js').load>>>>>>;
